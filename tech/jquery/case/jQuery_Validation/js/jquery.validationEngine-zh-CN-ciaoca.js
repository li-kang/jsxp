	...
	$.validationEngineLanguage = {
		newLang: function(){
			$.validationEngineLanguage.allRules = {
				...
				/**
				 * 建议在此处仅设置通用的规则，相对私有的规则可以在实际使用时创建，在外部设置方法为：
				 * $.validationEngineLanguage.allRules.ruleName = { ruleConfig };
				 * { ruleConfig } 的规则参考当前文件
				 *
				 *
				 * 自定义公用提示信息
				 ...
				 * Ajax PHP 验证示例
				 * 	"ajaxUserCallPhp": {
				 * 		"url": "http://code.ciaoca.com/jquery/validation-engine/demo/js/languages/phpajax/ajaxValidateFieldUser",
				 ...
				 * 		"url": "http://code.ciaoca.com/jquery/validation-engine/demo/js/languages/phpajax/ajaxValidateFieldName",
				 * 		// error
				 * 		"alertText": "* 此名称已被其他人使用",
				 * 		// speaks by itself
