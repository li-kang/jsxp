...
var windowobject;			//表示html或者body  用于兼容
...
SmoothScroll.prototype = {
    ...
    , scrollHander: function () {			//订阅的scroll的滚动事件处理函数
    	clearTimeDown();
        var _this = this;
...
$(document).ready(function(){
	...
	//浏览器图标的旋转动画
	//jQueryRotateCompressed插件  用于logo旋转
	var rotateTimer;
	$("#guider_link1").hover(
		function(){
			var angle = 0;
